...
!(function(e) {
  ...
  function n(e) {
    (this.tokens = []), (this.tokens.links = {}), (this.options = e ||
      k.defaults), (this.rules = t.normal), this.options.gfm &&
      (this.options.tables ? (this.rules = t.tables) : (this.rules = t.gfm));
  }
  (t._label = /(?:\\[\[\]]|[^\[\]])+/), (t._title = /(?:"(?:\\"|[^"]|"[^"\n]*")*"|'\n?(?:[^'\n]+\n?)*'|\([^()]*\))/), (t.def = p(
    t.def
  )
    ...
    .replace("def", "\\n+(?=" + t.def.source + ")")
    .getRegex()), (t._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b"), (t.html = p(
    t.html
  )
    .replace("comment", /<!--[\s\S]*?-->/)
    .replace("closed", /<(tag)[\s\S]+?<\/\1>/)
    .replace("closing", /<tag(?:"[^"]*"|'[^']*'|\s[^'"\/>\s]*)*?\/?>/)
    .replace(/tag/g, t._tag)
    .getRegex()), (t.paragraph = p(t.paragraph)
    .replace("hr", t.hr)
    .replace("heading", t.heading)
    .replace("lheading", t.lheading)
    .replace("tag", "<" + t._tag)
    .getRegex()), (t.blockquote = p(t.blockquote)
    .replace("paragraph", t.paragraph)
    .getRegex()), (t.normal = d({}, t)), (t.gfm = d({}, t.normal, {
    fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\n? *\1 *(?:\n+|$)/,
    paragraph: /^/,
    heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
    ...
    for (e = e.replace(/^ +$/gm, ""); e; )
      if (
        ((i = this.rules.newline.exec(e)) &&
          ((e = e.substring(i[0].length)), i[0].length > 1 &&
            this.tokens.push({ type: "space" })), (i = this.rules.code.exec(e)))
      )
        (e = e.substring(i[0].length)), (i = i[0].replace(
          /^ {4}/gm,
          ""
        )), this.tokens.push({
          type: "code",
        ...
        }), (i = i[0].replace(/^ *> ?/gm, "")), this.token(
          i,
          n
        ), this.tokens.push({ type: "blockquote_end" });
      else if ((i = this.rules.list.exec(e))) {
        for (
          (e = e.substring(i[0].length)), (g = (l = i[2]).length >
            1), this.tokens.push({
            type: "list_start",
            ordered: g,
            start: g ? +l : ""
          }), (r = !1), (c = (i = i[0].match(this.rules.item)).length), (p = 0);
          p < c;
          p++
        )
          (h = (a = i[p]).length), ~(a = a.replace(
            /^ *([*+-]|\d+\.) +/,
            ""
          )).indexOf("\n ") &&
            ((h -= a.length), (a = this.options.pedantic
              ? a.replace(/^ {1,4}/gm, "")
              : a.replace(
                  new RegExp("^ {1," + h + "}", "gm"),
                  ""
            ...
            (l === (o = t.bullet.exec(i[p + 1])[0]) ||
              ...
              ((e = i.slice(p + 1).join("\n") + e), (p = c - 1))), (s = r ||
            /\n\n(?!\s*$)/.test(a)), p !== c - 1 &&
            ((r = "\n" === a.charAt(a.length - 1)), s ||
              (s = r)), this.tokens.push({
        ...
        (e = e.substring(i[0].length)), i[3] &&
          (i[3] = i[3].substring(1, i[3].length - 1)), (u = i[
          1
        ].toLowerCase()), this.tokens.links[u] ||
  ...
  function s(e, t) {
    if (
      ((this.options = t ||
        k.defaults), (this.links = e), (this.rules = r.normal), (this.renderer = this.options.renderer ||
        new i()), (this.renderer.options = this.options), !this.links)
    )
  ...
  function o(e) {
    (this.tokens = []), (this.token = null), (this.options = e ||
      k.defaults), (this.options.renderer = this.options.renderer ||
  ...
  (r._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/), (r._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/), (r.autolink = p(
    r.autolink
  )
    .replace("scheme", r._scheme)
    .replace("email", r._email)
    .getRegex()), (r._inside = /(?:\[[^\[\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/), (r._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/), (r.link = p(
    r.link
  )
    .replace("inside", r._inside)
    .replace("href", r._href)
    .getRegex()), (r.reflink = p(r.reflink)
    .replace("inside", r._inside)
    .getRegex()), (r.normal = d({}, r)), (r.pedantic = d({}, r.normal, {
    ...
    for (var t, n, r, s, i = ""; e; )
      if ((s = this.rules.escape.exec(e)))
        ...
        (e = e.substring(s[0].length)), (r = "@" === s[2]
          ? "mailto:" + (n = a(this.mangle(s[1])))
          : (n = a(s[1]))), (i += this.renderer.link(r, null, n));
        ...
        if ((s = this.rules.tag.exec(e)))
          !this.inLink && /^<a /i.test(s[0])
            ...
            ? this.options.sanitizer ? this.options.sanitizer(s[0]) : a(s[0])
            : s[0]);
        else if ((s = this.rules.link.exec(e)))
          (e = e.substring(
            s[0].length
          )), (this.inLink = !0), (i += this.outputLink(s, {
            href: s[2],
            title: s[3]
          })), (this.inLink = !1);
        else if (
          (s = this.rules.reflink.exec(e)) || (s = this.rules.nolink.exec(e))
        ) {
          if (
            ((e = e.substring(s[0].length)), (t = (s[2] || s[1])
          ...
          (e = e.substring(s[0].length)), (i += this.renderer.strong(
            this.output(s[2] || s[1])
          ));
        else if ((s = this.rules.em.exec(e)))
          (e = e.substring(s[0].length)), (i += this.renderer.em(
            this.output(s[2] || s[1])
          ));
        else if ((s = this.rules.code.exec(e)))
          (e = e.substring(s[0].length)), (i += this.renderer.codespan(
            a(s[2].trim(), !0)
          ));
        else if ((s = this.rules.br.exec(e)))
          (e = e.substring(s[0].length)), (i += this.renderer.br());
        else if ((s = this.rules.del.exec(e)))
          (e = e.substring(s[0].length)), (i += this.renderer.del(
            this.output(s[1])
          ));
        else if ((s = this.rules.text.exec(e)))
          (e = e.substring(s[0].length)), (i += this.renderer.text(
            a(this.smartypants(s[0]))
          ));
        else if (e)
          throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
      } else
        (s[0] = this.rules._backpedal.exec(s[0])[0]), (e = e.substring(
          s[0].length
        )), "@" === s[2]
          ? (r = "mailto:" + (n = a(s[0])))
          : ((n = a(s[0])), (r = "www." === s[1]
              ? "http://" + n
              : n)), (i += this.renderer.link(r, null, n));
    return i;
    ...
    for (var t, n = "", r = e.length, s = 0; s < r; s++)
      (t = e.charCodeAt(s)), Math.random() > 0.5 &&
    ...
    (this.inline = new s(e.links, this.options)), (this.inlineText = new s(
      e.links,
      d({}, this.options, { renderer: new l() })
    ...
    switch (this.token.type) {
      ...
      case "loose_item_start":
        ...
        return this.renderer.listitem(i);
      case "html":
        var a = this.token.pre || this.options.pedantic
          ? this.token.text
          : this.inline.output(this.token.text);
  ...
  function k(e, t, r) {
    ...
    if (r || "function" == typeof t) {
      r || ((r = t), (t = null));
      var s, i, l = (t = d({}, k.defaults, t || {})).highlight, h = 0;
      try {
        s = n.lex(e, t);
      } catch (e) {
        return r(e);
  ...
  (f.exec = f), (k.options = (k.setOptions = function(e) {
    ...
    xhtml: !1,
    baseUrl: null
  }), (k.Parser = o), (k.parser = o.parse), (k.Renderer = i), (k.TextRenderer = l), (k.Lexer = n), (k.lexer = n.lex), (k.InlineLexer = s), (k.inlineLexer = s.output), (k.parse = k), "undefined" !=
